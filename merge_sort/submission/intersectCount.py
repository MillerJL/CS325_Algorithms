...
#
# Usage: python intersectCount.py *path_to_input_file*
# Outputs: File containing number of intersections called output.txt
#
# Requires file format provided in assignment description and example test
# inputs provided in a csv format
# Example:
# Line1 point_count
# Line2 q_values
# Line3 p_values
